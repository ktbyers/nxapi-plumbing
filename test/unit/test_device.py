...
class TestDevice(unittest.TestCase):
    ...
    def test_show_raw_text(self):
        ...
        self.send_request.assert_called_with(
            ["sh clock"], method=u"cli_ascii", timeout=30
        )
    ...
    def test_show_list(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            ["sh clock", "sh hostname"], method=u"cli", timeout=30
        )
    ...
    def test_show_list_raw_text(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            ["sh clock", "sh hostname"], method=u"cli_ascii", timeout=30
        )
    ...
    def test_config(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            ["int ethernet 1/1"], method=u"cli", timeout=30
        )
    ...
    def test_save(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            [u"copy run startup-config"], method=u"cli_ascii", timeout=30
        )
    ...
    def test_save_error(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            [u"copy run abc"], method=u"cli_ascii", timeout=30
        )
    ...
    def test_file_copy_remote_exists(self, mock_fc):
        ...
        mock_fc.assert_called_with(
            self.device, "source", dst="dest", file_system="bootflash:"
        )
    ...
    def test_get_boot_options(self):
        ...
        self.assertEqual(result, expected)
        self.send_request.assert_called_with(
            ["show install all status"], method=u"cli_ascii", timeout=30
        )
    ...
    def test_rollback(self, mock_show):
        ...
        mock_show.assert_called_with(
            "rollback running-config file rb_file", raw_text=True
        )
